...
namespace PollyWebApi.Client.Controllers;
	...
	: ControllerBase
{
	...
	{
		var httpClient = httpClientFactory.CreateClient("PollyWebApi.Client");
		   ...
		   .AddRetry(new RetryStrategyOptions
					 {
						 ...
						 {
							 logger.LogWarning(
								 $"Retry {args.AttemptNumber}, due to: {args.Outcome.Exception?.Message}.");
							 return default;
						 }
					 })
		   .Build();
