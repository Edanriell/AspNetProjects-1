...
using System.Text;
using BasicRoleBasedAuthorization.Authentication;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Mvc;
using Microsoft.IdentityModel.Tokens;

namespace BasicRoleBasedAuthorization.Controllers;
    ...
    : ControllerBase
{
    ...
    private async Task<IActionResult> RegisterUserWithRole(AddOrUpdateAppUserModel model, string roleName)
    {
        if (ModelState.IsValid)
        {
            ...
            foreach (var error in userResult.Errors) ModelState.AddModelError("", error.Description);
