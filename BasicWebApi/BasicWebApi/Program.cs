...
using BasicWebApi.HealthChecks;
using BasicWebApi.Models.Validators;
using BasicWebApi.OpenTelemetry.Metrics;
...
using Serilog;
using CustomerService = BasicWebApi.Services.CustomerService;
using ProductService = BasicWebApi.Services.ProductService;
...
builder.Services.AddOpenTelemetry()
   .ConfigureResource(config => { config.AddService(nameof(BasicWebApi)); })
	//.UseAzureMonitor()
   .WithMetrics(metrics =>
	{
