...
namespace BasicEfCore.Migrations
{
    ...
    [Migration("20240514081146_AddSeedData")]
            ...
            modelBuilder.Entity("BasicEfCore.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4b426e33-1925-4a60-889b-04e61b90cc6f"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("68ccefb6-4e3a-4b90-ba6c-115ec8a385a0"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("bc35c599-fa4b-46c2-89e5-2a20b4c2af34"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
