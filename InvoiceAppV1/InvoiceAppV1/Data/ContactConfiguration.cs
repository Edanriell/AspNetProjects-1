...
public class ContactConfiguration : IEntityTypeConfiguration<Contact>
{
    public void Configure(EntityTypeBuilder<Contact> builder)
    {
        ...
        builder.Property(p => p.FirstName).HasColumnName(nameof(Contact.FirstName)).HasColumnType("varchar(64)")
            .IsRequired();
        builder.Property(p => p.LastName).HasColumnName(nameof(Contact.LastName)).HasColumnType("varchar(64)")
            .IsRequired();
