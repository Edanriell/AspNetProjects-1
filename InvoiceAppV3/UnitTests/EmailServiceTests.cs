...
public class EmailServiceTests
{
    ...
    public void GenerateInvoiceEmail_Should_Return_Email()
    {
        ...
        // Act
        var (to, subject, body) =
            new EmailService(_loggerMock.Object, _emailSenderMock.Object).GenerateInvoiceEmail(invoice);
    ...
    public async Task SendEmailAsync_Should_Send_Email()
    {
        ...
        // Assert
        _emailSenderMock.Verify(m => m.SendEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()),
            Times.Once);
        _loggerMock.Verify(
            l => l.Log(
                It.IsAny<LogLevel>(),
