...
//     app.UseWhen(context => context.Request.QueryString.Value == $"?{luckyNumber.ToString()}",
//         app =>
//         {
//             app.Run(async context =>
//             {
...
//             await next(context);
//         });
//         app.MapWhen(context => context.Request.Headers["number"] == luckyNumber.ToString(),
//             app =>
//             {
//                 app.Run(async context =>
//                 {
...
//         "Use the /lottery URL to play. You can choose your number with the format /lottery?1.");
// });
...
//     });
// });
// Use MapWhen when you want to execute a specific set of middleware only for requests that match a certain condition.
// It's useful for creating conditional branches in the middleware pipeline, allowing you to handle different types of requests differently.
...
//     });
// });
// Use UseWhen when you want to conditionally apply a middleware to the entire pipeline based on a specific condition.
// It's useful when you want a middleware to execute for every request that meets the condition, without creating separate branches in the pipeline.
