...
public class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
{
    public void Configure(EntityTypeBuilder<Invoice> builder)
    {
        ...
        builder.Property(p => p.InvoiceNumber).HasColumnName(nameof(Invoice.InvoiceNumber)).HasColumnType("varchar(32)")
            .IsRequired();
        ...
        builder.Property(p => p.InvoiceDate).HasColumnName(nameof(Invoice.InvoiceDate)).HasColumnType("datetimeoffset")
            .IsRequired();
        builder.Property(p => p.DueDate).HasColumnName(nameof(Invoice.DueDate)).HasColumnType("datetimeoffset")
            .IsRequired();
